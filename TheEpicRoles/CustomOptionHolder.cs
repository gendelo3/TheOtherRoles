...
namespace TheEpicRoles {
    public class CustomOptionHolder {
        ...
        public static void Load() {
            ...
            vampireCanKillNearGarlics = CustomOption.Create(43, "Vampire Can Kill\nNear Garlics", "impostor", true, vampireSpawnRate);
            ...
            eraserCanEraseAnyone = CustomOption.Create(232, "Eraser Can\nErase Anyone", "impostor", false, eraserSpawnRate);
            ...
            tricksterLightsOutCooldown = CustomOption.Create(252, "Trickster Lights\nOut Cooldown", "impostor", 30f, 10f, 60f, 5f, tricksterSpawnRate);
            tricksterLightsOutDuration = CustomOption.Create(253, "Trickster Lights\nOut Duration", "impostor", 15f, 5f, 60f, 2.5f, tricksterSpawnRate);
            ...
            bountyHunterBountyDuration = CustomOption.Create(321, "Duration After Which\nBounty Changes", "impostor", 60f, 10f, 180f, 10f, bountyHunterSpawnRate);
            bountyHunterReducedCooldown = CustomOption.Create(322, "Cooldown After\nKilling Bounty", "impostor", 2.5f, 0f, 30f, 2.5f, bountyHunterSpawnRate);
            bountyHunterPunishmentTime = CustomOption.Create(323, "Additional Cooldown\nAfter Killing Others", "impostor", 20f, 0f, 60f, 2.5f, bountyHunterSpawnRate);
            bountyHunterShowArrow = CustomOption.Create(324, "Show Arrow Pointing\nTowards The Bounty", "impostor", true, bountyHunterSpawnRate);
            bountyHunterArrowUpdateIntervall = CustomOption.Create(325, "Arrow Update Intervall", "impostor", 5f, 0f, 60f, 2.5f, bountyHunterShowArrow);

            witchSpawnRate = CustomOption.Create(370, cs(Witch.color, "Witch"), "impostor", rates, null, true);
            witchCooldown = CustomOption.Create(371, "Witch Spell\nCasting Cooldown", "impostor", 30f, 10f, 120f, 5f, witchSpawnRate);
            ...
            witchVoteSavesTargets = CustomOption.Create(376, "Voting The Witch Saves\nAll The Targets", "impostor", true, witchSpawnRate);
            ...
            loversImpLoverRate = CustomOption.Create(51, "Chance That One\nLover Is Impostor", "other", rates, loversSpawnRate);
            loversBothDie = CustomOption.Create(52, "Both Lovers Die", "other", true, loversSpawnRate);
            loversCanHaveAnotherRole = CustomOption.Create(53, "Lovers Can Have\nAnother Role", "other", true, loversSpawnRate);
            ...
            guesserIsImpGuesserRate = CustomOption.Create(311, "Chance That The Guesser\nIs An Impostor", "other", rates, guesserSpawnRate);
            guesserNumberOfShots = CustomOption.Create(312, "Guesser Number Of Shots", "other", 2f, 1f, 15f, 1f, guesserSpawnRate);
            guesserHasMultipleShotsPerMeeting = CustomOption.Create(313, "Guesser Can Shoot\nMultiple Times Per Meeting", "other", false, guesserSpawnRate);
            guesserShowInfoInGhostChat = CustomOption.Create(314, "Guesses Visible\nIn Ghost Chat", "other", true, guesserSpawnRate);
            guesserKillsThroughShield  = CustomOption.Create(315, "Guesses Ignore\nThe Medic Shield", "other", true, guesserSpawnRate);
            guesserEvilCanKillSpy  = CustomOption.Create(316, "Evil Guesser\nCan Guess The Spy", "other", true, guesserSpawnRate);
            guesserSpawnBothRate = CustomOption.Create(317, "Both Guesser Spawn Rate", "other", rates, guesserSpawnRate);
            guesserCantGuessSnitchIfTaksDone = CustomOption.Create(318, "Guesser Can't Guess Snitch\nWhen Tasks Completed", "other", true, guesserSpawnRate);

            jesterSpawnRate = CustomOption.Create(60, cs(Jester.color, "Jester"), "neutral", rates, null, true);
            jesterCanCallEmergency = CustomOption.Create(61, "Jester Can Call\nEmergency Meeting", "neutral", true, jesterSpawnRate);
            ...
            jackalKillCooldown = CustomOption.Create(221, "Jackal/Sidekick\nKill Cooldown", "neutral", 30f, 10f, 60f, 2.5f, jackalSpawnRate);
            jackalCreateSidekickCooldown = CustomOption.Create(222, "Jackal Create\nSidekick Cooldown", "neutral", 30f, 10f, 60f, 2.5f, jackalSpawnRate);
            ...
            sidekickPromotesToJackal = CustomOption.Create(225, "Sidekick Gets Promoted\nTo Jackal On Jackal Death", "neutral", false, jackalSpawnRate);
            ...
            jackalPromotedFromSidekickCanCreateSidekick = CustomOption.Create(228, "Jackals Promoted From Sidekick\nCan Create A Sidekick", "neutral", true, jackalSpawnRate);
            jackalCanCreateSidekickFromImpostor = CustomOption.Create(229, "Jackals Can Make An\nImpostor To His Sidekick", "neutral", true, jackalSpawnRate);
            jackalAndSidekickHaveImpostorVision = CustomOption.Create(430, "Jackal And Sidekick\nHave Impostor Vision", "neutral", false, jackalSpawnRate);
            ...
            vultureNumberToWin = CustomOption.Create(342, "Number Of Corpses\nNeeded To Be Eaten", "neutral", 4f, 1f, 10f, 1f, vultureSpawnRate);
            vultureCanUseVents = CustomOption.Create(343, "Vulture Can Use Vents", "neutral", true, vultureSpawnRate);
            vultureShowArrows = CustomOption.Create(344, "Show Arrows Pointing\nTowards The Corpses", "neutral", true, vultureSpawnRate);
            ...
            engineerHighlightForTeamJackal = CustomOption.Create(93, "Jackal and Sidekick\nSee Vents Highlighted ", "crewmate", true, engineerSpawnRate);
            ...
            lighterModeLightsOnVision = CustomOption.Create(111, "Lighter Mode Vision\nOn Lights On", "crewmate", 2f, 0.25f, 5f, 0.25f, lighterSpawnRate);
            lighterModeLightsOffVision = CustomOption.Create(112, "Lighter Mode Vision\nOn Lights Off", "crewmate", 0.75f, 0.25f, 5f, 0.25f, lighterSpawnRate);
            ...
            detectiveReportNameDuration = CustomOption.Create(124, "Time Where Detective Reports\nWill Have Name", "crewmate", 0, 0, 60, 2.5f, detectiveSpawnRate);
            detectiveReportColorDuration = CustomOption.Create(125, "Time Where Detective Reports\nWill Have Color Type", "crewmate", 20, 0, 120, 2.5f, detectiveSpawnRate);
            ...
            medicShowAttemptToShielded = CustomOption.Create(144, "Shielded Player\nSees Murder Attempt", "crewmate", false, medicSpawnRate);
            medicSetShieldAfterMeeting = CustomOption.Create(145, "Shield Will Be Set\nAfter The Next Meeting", "crewmate", false, medicSpawnRate);
            medicShowAttemptToMedic = CustomOption.Create(146, "Medic Sees Murder Attempt\nOn Shielded Player", "crewmate", false, medicSpawnRate);
            ...
            hackerOnlyColorType = CustomOption.Create(173, "Hacker Only Sees\nColor Type", "crewmate", false, hackerSpawnRate);
            hackerToolsNumber = CustomOption.Create(174, "Max Mobile Gadget Charges", "crewmate", 5f, 1f, 30f, 1f, hackerSpawnRate);
            hackerRechargeTasksNumber = CustomOption.Create(175, "Number Of Tasks\nNeeded For Recharging", "crewmate", 2f, 1f, 5f, 1f, hackerSpawnRate);
            hackerNoMove = CustomOption.Create(176, "Cant Move During\nMobile Gadget Duration", "crewmate", true, hackerSpawnRate);
            ...
            trackerResetTargetAfterMeeting = CustomOption.Create(202, "Tracker Reset Target\nAfter Meeting", "crewmate", false, trackerSpawnRate);
            ...
            snitchLeftTasksForReveal = CustomOption.Create(211, "Task Count Where\nThe Snitch Will Be Revealed", "crewmate", 1f, 0f, 5f, 1f, snitchSpawnRate);
            snitchIncludeTeamJackal = CustomOption.Create(212, "Include Team Jackal", "crewmate", false, snitchSpawnRate);
            snitchTeamJackalUseDifferentArrowColor = CustomOption.Create(213, "Use Different Arrow Color\nFor Team Jackal", "crewmate", true, snitchIncludeTeamJackal);
            ...
            spyImpostorsCanKillAnyone = CustomOption.Create(242, "Impostors Can Kill Anyone\nIf There Is A Spy", "crewmate", true, spySpawnRate);
            ...
            securityGuardTotalScrews = CustomOption.Create(282, "Number Of Screws", "crewmate", 7f, 1f, 15f, 1f, securityGuardSpawnRate);
            ...
            securityGuardCamRechargeTasksNumber = CustomOption.Create(287, "Number Of Tasks Needed\nFor Recharging", "crewmate", 3f, 1f, 10f, 1f, securityGuardSpawnRate);
            ...
            baitHighlightAllVents = CustomOption.Create(331, "Highlight All Vents\nIf A Vent Is Occupied", "crewmate", false, baitSpawnRate);
            ...
            mediumOneTimeUse = CustomOption.Create(363, "Each Soul Can Only\nBe Questioned Once", "crewmate", false, mediumSpawnRate);
            ...
            // Other options
            maxNumberOfMeetings = CustomOption.Create(3, cs(new Color(0, 1, 217f / 255f, 1f), "Number Of Meetings\n(excluding Mayor meeting)"), "option", 10, 0, 15, 1, null, true);
            blockSkippingInEmergencyMeetings = CustomOption.Create(4, cs(new Color(0, 1, 217f / 255f, 1f), "Block Skipping\nIn Emergency Meetings"), "option", false);
