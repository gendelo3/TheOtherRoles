...
namespace TheEpicRoles.Modules {
    ...
    public class ModUpdater { 
        ...
        public static void LaunchUpdater() {
            ...
            clearOldVersions();
            if (hasUpdate || TheEpicRolesPlugin.ShowPopUpVersion.Value != TheEpicRolesPlugin.VersionString) {
                DestroyableSingleton<MainMenuManager>.Instance.Announcement.gameObject.SetActive(true);
                TheEpicRolesPlugin.ShowPopUpVersion.Value = TheEpicRolesPlugin.VersionString;
            }
        }
        ...
        public static async Task<bool> checkForUpdate() {
            try {
                ...
                http.DefaultRequestHeaders.Add("User-Agent", "TheEpicRoles Updater");
                ...
                int diff = TheEpicRolesPlugin.Version.CompareTo(ver);
