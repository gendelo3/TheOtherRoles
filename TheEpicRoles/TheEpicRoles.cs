...
{
    [HarmonyPatch]
    public static class TheEpicRoles
    {
        ...
        public static class Engineer {
            ...
            public static Sprite getButtonSprite() {
                ...
                buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.RepairButton.png", 115f);
                return buttonSprite;
            }
        ...
        public static class Janitor {
            ...
            public static Sprite getButtonSprite() {
                if (buttonSprite) return buttonSprite;
                buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.CleanButton.png", 115f);
                return buttonSprite;
            }
        ...
        public static class Deputy
        {
            ...
            {
                if (buttonSprite) return buttonSprite;
                buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.DeputyHandcuffButton.png", 115f);
                return buttonSprite;
            }
            ...
            public static Sprite getHandcuffedButtonSprite()
            {
                ...
                handcuffedSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.DeputyHandcuffed.png", 115f);
        ...
        public static class Lighter {
            ...
            public static Sprite getButtonSprite() {
                if (buttonSprite) return buttonSprite;
                buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.LighterButton.png", 115f);
                return buttonSprite;
            }
    ...
    public static class TimeMaster {
        ...
        public static Sprite getButtonSprite() {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.TimeShieldButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Medic {
        ...
        public static Sprite getButtonSprite() {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.ShieldButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Shifter {
        ...
        public static Sprite getButtonSprite() {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.ShiftButton.png", 115f);
            return buttonSprite;
        }
        ...
        {
            return target.Data.Role.IsImpostor || target == Jackal.jackal || target == Sidekick.sidekick || Jackal.formerJackals.Contains(target) || target == TheEpicRoles.Jester.jester || target == Arsonist.arsonist || target == Vulture.vulture || target == Lawyer.lawyer;
        }
    ...
    public static class Swapper {
        ...
        public static Sprite getCheckSprite() {
            ...
            spriteCheck = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.SwapperCheck.png", 150f);
            return spriteCheck;
        }
    ...
    public static class Seer {
        ...
        public static Sprite getSoulSprite() {
            ...
            soulSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.Soul.png", 500f);
            return soulSprite;
        }
    ...
    public static class Morphling {
        ...
        public static Sprite getSampleSprite() {
            ...
            sampleSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.SampleButton.png", 115f);
            return sampleSprite;
        }

        public static Sprite getMorphSprite() {
            if (morphSprite) return morphSprite;
            morphSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.MorphButton.png", 115f);
            return morphSprite;
        }
    }
    ...
    public static class Camouflager {
        ...
        public static Sprite getButtonSprite() {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.CamoButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Hacker {
        ...
        public static Sprite getButtonSprite() {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.HackerButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Tracker {
        ...
        public static Sprite getTrackCorpsesButtonSprite()
        {
            ...
            trackCorpsesButtonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.PathfindButton.png", 115f);
        ...
        public static Sprite getButtonSprite() {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.TrackerButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Vampire {
        ...
        public static Sprite getButtonSprite() {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.VampireButton.png", 115f);
            return buttonSprite;
        }
        ...
        public static Sprite getGarlicButtonSprite() {
            ...
            garlicButtonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.GarlicButton.png", 115f);
    ...
    public static class Jackal {
        ...
        public static Sprite getSidekickButtonSprite() {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.SidekickButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Eraser {
        ...
        public static Sprite getButtonSprite() {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.EraserButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Trickster {
        ...
        public static Sprite getPlaceBoxButtonSprite() {
            ...
            placeBoxButtonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.PlaceJackInTheBoxButton.png", 115f);
        ...
        public static Sprite getLightsOutButtonSprite() {
            ...
            lightOutButtonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.LightsOutButton.png", 115f);
        ...
        public static Sprite getTricksterVentButtonSprite() {
            ...
            tricksterVentButtonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.TricksterVentButton.png", 115f);
    ...
    public static class Warlock {
        ...
        public static Sprite getCurseButtonSprite() {
            ...
            curseButtonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.CurseButton.png", 115f);
        ...
        public static Sprite getCurseKillButtonSprite() {
            ...
            curseKillButtonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.CurseKillButton.png", 115f);
    ...
    public static class SecurityGuard {
        ...
        public static Sprite getCloseVentButtonSprite() {
            ...
            closeVentButtonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.CloseVentButton.png", 115f);
        ...
        public static Sprite getPlaceCameraButtonSprite() {
            ...
            placeCameraButtonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.PlaceCameraButton.png", 115f);
        ...
        public static Sprite getAnimatedVentSealedSprite() {
            ...
            animatedVentSealedSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.AnimatedVentSealed.png", 160f);
        ...
        public static Sprite getStaticVentSealedSprite() {
            ...
            staticVentSealedSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.StaticVentSealed.png", 160f);
    ...
    public static class Arsonist {
        ...
        public static Sprite getDouseSprite() {
            ...
            douseSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.DouseButton.png", 115f);
            return douseSprite;
        }
        ...
        public static Sprite getIgniteSprite() {
            ...
            igniteSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.IgniteButton.png", 115f);
            return igniteSprite;
        }
    ...
    public static class Guesser {
        ...
        public static Sprite getTargetSprite() {
            ...
            targetSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.TargetIcon.png", 150f);
            return targetSprite;
        }
    ...
    public static class Vulture {
        ...
        public static Sprite getButtonSprite() {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.VultureButton.png", 115f);
            return buttonSprite;
        }
    ...
    public static class Medium {
        ...
        public static Sprite getQuestionSprite() {
            ...
            question = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.MediumButton.png", 115f);
            return question;
        }
    ...
    public static class Pursuer {
        ...
        public static Sprite getTargetSprite() {
            ...
            blank = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.PursuerButton.png", 115f);
            return blank;
        }
    ...
    public static class Witch {
        ...
        public static Sprite getButtonSprite() {
            if (buttonSprite) return buttonSprite;
            buttonSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.SpellButton.png", 115f);
            return buttonSprite;
        }
        ...
        public static Sprite getSpelledOverlaySprite() {
            ...
            spelledOverlaySprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.SpellButtonMeeting.png", 225f);
