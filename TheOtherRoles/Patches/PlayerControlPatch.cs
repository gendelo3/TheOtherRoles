...
namespace TheOtherRoles.Patches {
    ...
    public static class PlayerControlFixedUpdatePatch {
        ...
        public static void securityGuardSetTarget() {
            if ((SecurityGuard.securityGuard == null || SecurityGuard.securityGuard != PlayerControl.LocalPlayer) && (Doppelganger.doppelganger == null ||Doppelganger.copiedRole != RoleInfo.securityGuard || PlayerControl.LocalPlayer != Doppelganger.doppelganger) || MapUtilities.CachedShipStatus == null || MapUtilities.CachedShipStatus.AllVents == null) return;
        ...
        public static void mediumSetTarget() {
            if (Medium.medium != PlayerControl.LocalPlayer && !Doppelganger.isRoleAndLocalPlayer(RoleInfo.medium) || PlayerControl.LocalPlayer.Data.IsDead || Medium.deadBodies == null || MapUtilities.CachedShipStatus.AllVents == null) return;
