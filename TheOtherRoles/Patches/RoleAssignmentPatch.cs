...
namespace TheOtherRoles.Patches {
    ...
    class RoleManagerSelectRolesPatch {
        ...
        private static bool isGuesserGamemode = MapOptions.gameMode == CustomGamemodes.Guesser;
        ...
        private static void assignGuesserGamemode() {
            ...
            assignGuesserGamemodeToPlayers(neutralPlayer, Mathf.RoundToInt(CustomOptionHolder.guesserGamemodeNeutralNumber.getFloat()));
